...
export function LocationSearch({ locationLabel }: { locationLabel?: string }) {
  ...
  return (
    <div className="panel mb-6 flex flex-col gap-3" data-location-search>
      <div
        className="flex flex-col gap-3 sm:flex-row sm:items-center"
        data-location-search-controls
      >
      ...
      {geoState === "error" ? (
        <p
          className="text-xs text-[var(--ae-danger)]"
          data-location-search-error
          role="alert"
        >
